...
public class ItSemThree extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_it_sem_three);
        ...
        calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                double res=(subOne*3+subTwo*3+subThree*4+subFour*3+subFive*2+subSix+subSeven*1.5+subEight*1.5+subNine);
                res=res/20;
