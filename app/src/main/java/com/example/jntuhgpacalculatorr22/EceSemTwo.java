...
public class EceSemTwo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ece_sem_two);
        ...
        calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                double res=(subOne*4+subTwo*4+subThree*3+subFour*2+subFive*2+subSix+subSeven*2+subEight+subNine);
                res=res/20;
