...
public class MiningSemSeven extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mining_sem_seven);
        ...
        calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                double res=(subOne*3+subTwo*3+subThree*3+subFour*3+subFive*2+subSix*2+subSeven+subEight*3);
                res=res/20;
