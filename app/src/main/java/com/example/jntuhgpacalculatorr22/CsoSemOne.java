...
public class CsoSemOne extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cso_sem_one);
        ...
        calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                double res=(subOne*4+subTwo*4+subThree*3+subFour*2.5+subFive*2+subSix+subSeven*1.5+subEight+subNine);
                res=res/20;
