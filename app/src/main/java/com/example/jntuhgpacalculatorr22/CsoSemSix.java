...
public class CsoSemSix extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cso_sem_six);
        ...
        calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                double res=(subOne*3+subTwo*3+subThree*3+subFour*3+subFive*3+subSix*1.5+subSeven*1.5+subEight*2);
                res=res/20;
