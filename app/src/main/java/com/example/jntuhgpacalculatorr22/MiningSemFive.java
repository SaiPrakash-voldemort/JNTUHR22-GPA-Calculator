...
public class MiningSemFive extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mining_sem_five);
        ...
        calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                double res=(subOne*3+subTwo*3+subThree*3+subFour*3+subFive*3+subSix*2+subSeven+subEight+subNine);
                res=res/20;
