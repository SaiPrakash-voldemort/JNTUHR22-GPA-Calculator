...
public class ItSemFour extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_it_sem_four);
        EditText sOne,sTwo,sThree,sFour,sFive,sSix,sSeven,sEight,sNine,sTen;
        Button calc;
        TextView result;
        ...
        sTen=findViewById(R.id.editTextNumber10);
        ...
        calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int subTen=Integer.parseInt(sTen.getText().toString());

                double res=(subOne*3+subTwo*3+subThree*3+subFour*3+subFive*2+subSix+subSeven+subEight*2+subNine+subTen);
                res=res/20;
