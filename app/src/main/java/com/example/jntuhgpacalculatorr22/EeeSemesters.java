...
public class EeeSemesters extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eee_semesters);
    ...
    public void openSemOne(){
        Intent intent=new Intent(this,EeeSemOne.class);
        startActivity(intent);
    }
    public void openSemTwo(){
        Intent intent=new Intent(this,EeeSemTwo.class);
        startActivity(intent);
    }
    public void openSemThree(){
        Intent intent=new Intent(this,EeeSemThree.class);
        startActivity(intent);
    }
    public void openSemFour(){
        Intent intent=new Intent(this,EeeSemFour.class);
        startActivity(intent);
    }
    public void openSemFive(){
        Intent intent=new Intent(this,EeeSemFive.class);
        startActivity(intent);
    }
    public void openSemSix(){
        Intent intent=new Intent(this,EeeSemSix.class);
        startActivity(intent);
    }
    public void openSemSeven(){
        Intent intent=new Intent(this,EeeSemSeven.class);
        startActivity(intent);
    }
    public void openSemEight(){
        Intent intent=new Intent(this,EeeSemEght.class);
        startActivity(intent);
    }
}